...
SpSub: 		ldhx LOW(SpSubSize+4),sp ;get flash address from stack
			...
			lda #$80 ;mask to initiate command mFCBEF;
...
FlashErase:psha ;adjust sp for DoOnStack entry
			lda #$30 ;mask mFPVIOL+mFACCERR;
			sta FSTAT ;abort any command and clear errors
			lda #$40 ;mask pattern for page erase command
...
FlashProg: psha ;temporarily save entry data
			lda #$30 ;mask mFPVIOL+mFACCERR;
			sta FSTAT ;abort any command and clear errors
			lda #$20 ;mask pattern for byte prog command
